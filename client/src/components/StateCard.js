...
export const StateCheckCard = ({type, name, count, CountHandlerPlus, CountHandlerMinus}) => {
    return(
        <CardCheck>
            <div>
                <div>
            ...
            <div className="count-area">
                <div onClick={CountHandlerMinus}><FontAwesomeIcon icon={faMinus}/></div>
                <div onClick={CountHandlerPlus}className="plus"><FontAwesomeIcon icon={faPlus}/></div>
            </div>
        </CardCheck>
    )
}
